...
theta_initial = [0 pi/2 -pi/2 0 0]; % Nessa posicao, sem aplicar torque o braco fica estavel e nao cai
...
legend('$dd\theta_1$', '$dd\theta_2$', '$dd\theta_3$', '$dd\theta_4$', '$dd\theta_5$','Interpreter','latex');
...
legend('$d\theta_1$', '$d\theta_2$', '$d\theta_3$', '$d\theta_4$', '$d\theta_5$','Interpreter','latex');
...
legend('$\theta_1$', '$\theta_2$', '$\theta_3$', '$\theta_4$', '$\theta_5$','Interpreter','latex');
...
legend('1', '2', '3', '4', '5','Interpreter','latex');
