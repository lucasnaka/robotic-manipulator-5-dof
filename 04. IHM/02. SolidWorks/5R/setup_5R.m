...
s_3M1D.V = s_3M1D.V;
s_motor_2b.V = (Rz_pos*Rz_pos*s_motor_2b.V')';
...
s_motor_2a.V = s_motor_2a.V - [-29.5, 19, 120.8, 0];
s_motor_2b.V = s_motor_2b.V - [29.5, -19, 120.8, 0];
...
s_motor_2b.V = (Rz_neg*s_motor_2b.V')';

% Rotação para alinhar ligamento 2
s_2M2HA.V = (Rx_neg*s_2M2HA.V')';
s_2M2MA.V = (Rx_neg*s_2M2MA.V')';
s_3M1D.V = (Rx_neg*s_3M1D.V')';
...
p2a = patch('faces', s_motor_2a.F, 'vertices', s_motor_2a.V(:,1:3));
set(p2a, 'facec', [0.18,0.43,0.285]);
set(p2a, 'EdgeColor','none');

p2b = patch('faces', s_motor_2b.F, 'vertices', s_motor_2b.V(:,1:3));
set(p2b, 'facec', [0.18,0.43,0.285]);
set(p2b, 'EdgeColor','none');
