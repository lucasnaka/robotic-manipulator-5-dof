...
%   -     alpha    = elevação da garra em relação ao plano horizontal
...
% theta5
theta5 = alpha - theta2 - theta3 - pi/2;
...
% Como escolher entre uma das solucoes? Identificar matematicamente se o cotovelo esta para cima ou para baixo